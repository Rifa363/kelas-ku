                    ...
                    <form action="{{ route('admin.struktur.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="jabatan" class="block mt-1 w-full" type="text" name="jabatan" :value="old('jabatan')" placeholder="Ketua, Wakil Ketua, Sie. Acara, Anggota, ..." required />
                            ...
                            <div>
                                ...
                                <x-text-input id="urutan" class="block mt-1 w-full" type="number" name="urutan" :value="old('urutan', 0)" min="0" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="3" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500" placeholder="Tugas dan tanggung jawab...">{{ old('deskripsi') }}</textarea>
