<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Masuk ke akun TPLE006</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <div class="mt-1 relative">
                ...
                <x-text-input id="email" class="block mt-1 w-full pl-10" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="contoh@email.com" />
            </div>
